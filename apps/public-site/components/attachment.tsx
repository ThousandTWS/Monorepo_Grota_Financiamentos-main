...
import { Avatar, AvatarImage, AvatarFallback } from "@/src/presentation/components/ui/avatar";
...
export const ComposerAddAttachment: FC = () => {
  return (
    <ComposerPrimitive.AddAttachment asChild>
      ...
      >
        <PlusIcon className="aui-attachment-add-icon size-5 stroke-[1.5px] text-black" />
      </TooltipIconButton>

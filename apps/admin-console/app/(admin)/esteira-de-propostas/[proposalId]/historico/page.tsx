        ...
        {proposal ? (
          <section className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="rounded-xl border border-white/10 bg-white/10 p-4 shadow-sm">
              <div className="flex items-center gap-2 text-white/80 text-xs uppercase tracking-wide mb-2">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-lg bg-white/15 px-4 py-3 text-white">
                  ...
                  <p className="text-xs text-white/70">
                    Responsável: {proposal.sellerId ? `Responsável #${proposal.sellerId}` : "Não informado"}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-white/10 bg-white/10 p-4 shadow-sm lg:col-span-2">
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                <div className="rounded-lg bg-white/15 px-4 py-3 lg:col-span-2 text-white">
                ...
                <div className="rounded-lg bg-white/15 px-4 py-3 text-white">
                  ...
                  {proposal.notes ? (
                    <p className="text-xs text-white/70 mt-1">Observações: {proposal.notes}</p>
                  ) : null}
                </div>
              </div>
            </div>
        ...
        <section className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="rounded-xl border border-white/10 bg-white/10 p-4 shadow-sm text-white">
            ...
            {isLoading ? (
              ...
              <div className="mt-3 space-y-3 max-h-[420px] overflow-y-auto pr-1 scrollbar-hide">
                ...
                {sortedMessages.length === 0 ? (
                  ...
                  sortedMessages.map((msg) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className="relative max-w-[78%] rounded-3xl border border-white/10 bg-white/12 px-4 py-2 text-sm text-white shadow-sm backdrop-blur"
                        >

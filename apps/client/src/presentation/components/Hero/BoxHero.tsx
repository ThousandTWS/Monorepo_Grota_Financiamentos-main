...
import { ArrowRight, Calculator, Handshake, UserCheck } from "lucide-react";
...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[110vh] overflow-hidden -mt-24">
      ...
      <div className="relative z-10 flex flex-col items-center justify-start h-full pt-65 px-4">
        <div className="text-center text-white space-y-7 max-w-5xl mx-auto">
          <div className="space-y-6">
            <h1 className="text-5xl lg:text-6xl whitespace-pre-line font-bold leading-tight transition-all duration-500">
              Financiamento com Segurança<br /> e Confiança
            </h1>
            <p className="text-2xl whitespace-pre-line text-gray-200 leading-relaxed max-w-2xl mx-auto transition-all duration-500">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
            ...
            <Link target="_blank" href="href=https://api.whatsapp.com/send?phone=5519992837133&text=Ol%C3%A1!%20Tudo%20bem%3F%20Gostaria%20de%20mais%20informa%C3%A7%C3%B5es%20sobre%20finaciamento%20de%20ve%C3%ADculos.">
            <button className=" cursor-pointer group bg-white hover:bg-gray-100 text-[#1B4B7C] px-10 py-4 rounded-xl font-bold text-lg transition-all duration-300 flex items-center justify-center gap-3 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
              Seja nosso Parceiro
